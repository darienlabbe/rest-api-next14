...
export const GET = async (request: Request, context: {params: any}) => {
    ...
    try {
        ...
        if (!blog) {
            return new NextResponse(JSON.stringify({ message: "Blog not found in the database" }), { status: 400 });
        }
...
export const PATCH = async (request: Request, context: {params: any}) => {
    ...
    try {
        ...
        return new NextResponse("Error in updating a blog" + error.message, { status: 500 });
    }
};
...
export const DELETE = async (request: Request, context: {params: any}) => {
    ...
    try {
        ...
        return new NextResponse("Error in deleting a blog" + error.message, { status: 500 });
    }
};